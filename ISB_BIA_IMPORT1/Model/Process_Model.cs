...
namespace ISB_BIA_IMPORT1.Model
{
    ...
    /// </summary>
    public class Process_Model: ObservableObject
    {
        ...
        {
            get => _oE_Filter;
            set => Set(() => OE_Filter, ref _oE_Filter, value);
        ...
        {
            get => _prozess;
            set => Set(() => Prozess, ref _prozess, value);
        ...
        public string Kritikalität_des_Prozesses
        {
            ...
            set
            {
                ...
                else if (Kritischer_Prozess == "Ja" && value != "Sehr hoch" && RTO_Wiederanlaufzeit_Recovery_Time_Objective != 1 && !CritCalculation((int)SZ_4, (int)SZ_1, (int)SZ_3, (int)SZ_2))
                {
        ...
        public string Reifegrad_des_Prozesses
        {
            ...
            set => Set(() => Reifegrad_des_Prozesses, ref _reifegrad_des_Prozesses, value);
        ...
        public SZ_Values SZ_1
        {
            ...
            set
            {
                ...
                else if (Kritischer_Prozess == "Ja" && UnCritCalculation((int)value, (int)SZ_2, (int)SZ_3, (int)SZ_4) && Kritikalität_des_Prozesses != "Sehr hoch" && RTO_Wiederanlaufzeit_Recovery_Time_Objective != 1)
                {
                    Kritischer_Prozess = "Nein";
                }
            }
        ...
        public SZ_Values SZ_2
        {
            ...
            set
            {
                ...
                else if (Kritischer_Prozess == "Ja" && UnCritCalculation((int)value, (int)SZ_1, (int)SZ_3, (int)SZ_4) && Kritikalität_des_Prozesses != "Sehr hoch" && RTO_Wiederanlaufzeit_Recovery_Time_Objective != 1)
                {
                    Kritischer_Prozess = "Nein";
                }
            }
        ...
        public SZ_Values SZ_3
        {
            ...
            set
            {
                ...
                else if (Kritischer_Prozess == "Ja" && UnCritCalculation((int)value, (int)SZ_1, (int)SZ_2, (int)SZ_4) && Kritikalität_des_Prozesses != "Sehr hoch" && RTO_Wiederanlaufzeit_Recovery_Time_Objective != 1)
                {
                    Kritischer_Prozess = "Nein";
                }
            }
        ...
        public SZ_Values SZ_4
        {
            ...
            set
            {
                ...
                else if (Kritischer_Prozess == "Ja" && UnCritCalculation((int)value, (int)SZ_1, (int)SZ_3, (int)SZ_2) && Kritikalität_des_Prozesses != "Sehr hoch" && RTO_Wiederanlaufzeit_Recovery_Time_Objective != 1)
                {
                    Kritischer_Prozess = "Nein";
                }
            }
        ...
        public string Servicezeit_Helpdesk
        {
            ...
            set => Set(() => Servicezeit_Helpdesk, ref _servicezeit_Helpdesk, value);
        ...
        public int RPO_Datenverlustzeit_Recovery_Point_Objective
        {
            ...
            set => Set(() => RPO_Datenverlustzeit_Recovery_Point_Objective, ref _rPO_Datenverlustzeit_Recovery_Point_Objective, value);
        ...
        public int RTO_Wiederanlaufzeit_Recovery_Time_Objective
        {
            ...
            set
            {
                Set(() => RTO_Wiederanlaufzeit_Recovery_Time_Objective, ref _rTO_Wiederanlaufzeit_Recovery_Time_Objective, value);
                if (Kritischer_Prozess != "Ja" && value == 1)
                {
                    Kritischer_Prozess = "Ja";
                }
                else if (Kritischer_Prozess == "Ja" && value != 1 && Kritikalität_des_Prozesses != "Sehr hoch" && !CritCalculation((int)SZ_4, (int)SZ_1, (int)SZ_3, (int)SZ_2))
                {
                    Kritischer_Prozess = "Nein";
                }
            }
        ...
        public int RTO_Wiederanlaufzeit_Recovery_Time_Objective_Notfall
        {
            ...
            set => Set(() => RTO_Wiederanlaufzeit_Recovery_Time_Objective_Notfall, ref _rTO_Wiederanlaufzeit_Recovery_Time_Objective_Notfall, value);
        ...
        public string Prozessverantwortlicher
        {
            ...
            set => Set(() => Prozessverantwortlicher, ref _prozessverantwortlicher, value);
