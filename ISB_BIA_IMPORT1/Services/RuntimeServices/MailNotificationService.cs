...
namespace ISB_BIA_IMPORT1.Services
{
    ...
    class MailNotificationService : IMailNotificationService
    {
        IDialogService myDia;
        ISharedResourceService myShared;
        private static readonly string from = "BIA-Tool@isb.rlp.de";

        public MailNotificationService(IDialogService myDialogService, ISharedResourceService mySharedResourceService)
        {
