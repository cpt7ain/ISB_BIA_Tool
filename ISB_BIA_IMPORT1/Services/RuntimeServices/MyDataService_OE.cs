...
{
    public class MyDataService_OE : IMyDataService_OE
    {
        readonly IMyDialogService _myDia;
        readonly IMySharedResourceService _myShared;
        readonly IMyDataService_Lock _myLock;

        public MyDataService_OE(IMyDialogService myDia, IMySharedResourceService myShared, IMyDataService_Lock myLock)
        {
            this._myDia = myDia;
