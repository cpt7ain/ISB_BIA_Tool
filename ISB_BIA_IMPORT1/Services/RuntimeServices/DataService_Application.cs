...
{
    class DataService_Application : IDataService_Application
    {
        readonly IDialogService _myDia;
        readonly ISharedResourceService _myShared;
        readonly ILockService _myLock;

        public DataService_Application(IDialogService myDia, ISharedResourceService myShared, ILockService myLock)
        {
            this._myDia = myDia;
