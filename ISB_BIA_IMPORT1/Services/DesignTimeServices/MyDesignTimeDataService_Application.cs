...
{
    public class MyDesignTimeDataService_Application : IMyDataService_Application
    {
        public ObservableCollection<ISB_BIA_Applikationen> ApplicationDummyList;

        public MyDesignTimeDataService_Application()
        {
        ...
        {
            return Get_Applications_All().FirstOrDefault();
        }
