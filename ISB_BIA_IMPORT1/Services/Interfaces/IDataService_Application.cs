...
namespace ISB_BIA_IMPORT1.Services.Interfaces
{
    ...
    /// </summary>
    public interface IDataService_Application
    {
        #region Application
        /// <summary>
        ...
        Application_Model Get_Model_FromDB(int id);
        /// <summary>
