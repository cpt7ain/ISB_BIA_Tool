...
namespace ISB_BIA_IMPORT1.Services.Interfaces
{
    ...
    /// </summary>
    public interface IMyDataService_Process
    {
        #region Process
        /// <summary>
        ...
        Process_Model Get_ModelFromDB(int id);
        /// <summary>
        ...
        ISB_BIA_Prozesse Map_ModelToDB(Process_Model p);
        /// <summary>
        ...
        ObservableCollection<ISB_BIA_Prozesse> Get_Processes_ByOE(ObservableCollection<string> listOE);
        /// <summary>
        ...
        ObservableCollection<ISB_BIA_Prozesse> Get_Processes_All(DateTime? d = null);
        /// <summary>
        ...
        ObservableCollection<ISB_BIA_Prozesse> Get_Processes_Active();
        /// <summary>
        ...
        Dictionary<string, string> Get_List_ISDictionary();
        /// <summary>
        ...
        List<ISB_BIA_Informationssegmente> Get_Segments_5ForCalculation(Process_Model process);
        /// <summary>
        ...
        ObservableCollection<string> Get_List_ProcessOwner();
        /// <summary>
        /// Liste aller OE's welche für eine bestimmte OE(/User) relevant sind (für dropdown in Prozessbearbeitung1 und als Grundlage für bestimmung der relevanen Prozesse (=>OE anhängig) für Prozessübersicht2 <see cref="Get_Processes_ByOE"/>)
        /// </summary>
        /// <param name="userOE"> OE (e.g. 4.4) </param>
        /// <returns> Liste aller relevanten (=>untergeordneten) OE's (e.g. {4.4,4.401,4,402,4.403} ) </returns>
        ObservableCollection<string> Get_List_OEsForUser(string userOE);
        /// <summary>
        /// Liste aller OE's (für Admin/CISO dropdown1)
        /// </summary>
        /// <returns> String Liste aller OE's </returns>
        ObservableCollection<string> Get_List_OEs_All();
        /// <summary>
        /// Liste aller vorgelagerten Prozesse für Dropdown1
        /// </summary>
        /// <returns> String Liste aller vorgelagerten Prozesse</returns>
        ObservableCollection<string> Get_List_PreProcesses();
        /// <summary>
        /// Liste aller nachgelagerten Prozesse für Dropdown1
        /// </summary>
        /// <returns> String Liste aller nachgelagerten Prozesse </returns>
        ObservableCollection<string> Get_List_PostProcesses();
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        ObservableCollection<string> Get_List_AppCategories();
        /// <summary>
