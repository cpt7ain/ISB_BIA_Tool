...
namespace ISB_BIA_IMPORT1.Services
{
    ...
    public interface IMyDataService
    {
        ...
        /// </summary>
        /// <param name="sqlCommandList"> Liste der SQL Commands zur Löschung und Erstellung der Tabellen in richtiger Reihenfolge </param>
        ...
        /// <returns></returns>
        bool CreateDataModel(List<string> sqlCommandList, DataTable dt_Processes, DataTable dt_Applications, DataTable dt_Relation, DataTable dt_InformationSegments, DataTable dt_InformationSegmentAttributes);
        /// <summary>
