...
namespace ISB_BIA_IMPORT1.ViewModel
{
    ...
    /// </summary>
    public class SegmentsView_ViewModel : ViewModelBase
    {
        ...
        public ISISAttributeMode Mode
        {
            ...
            set
            {
                ...
                if (value == ISISAttributeMode.Edit)
                {
                    ...
                    List_InformationSegment = _myIS.Get_List_Segments_All();
                }
                else if (value == ISISAttributeMode.View)
                {
                    Str_Instruction = "Doppelklick auf ein Segment, das Sie betrachten möchten.";
                    List_InformationSegment = _myIS.Get_List_Segments_Enabled();
                }
            }
        }
        /// <summary>
        ...
        public SegmentsView_ViewModel(IDialogService myDia, INavigationService myNavi,
            IDataService_Segment myIS, IExportService myExp, ILockService myLock,
            IDataService_Setting mySett)
        {
            #region Services
            _myDia = myDia;
            _myNavi = myNavi;
            ...
            if (IsInDesignMode)
            {
                AttributeColumnHeaderText = _myIS.Get_StringList_AttributeNames();
                List_InformationSegment = _myIS.Get_List_Segments_All();
            ...
            else
            {
                ...
                {
                    if (!(n.Sender is INavigationService)) return;
                    Mode = n.Content;
                });
