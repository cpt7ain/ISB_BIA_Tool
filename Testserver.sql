...
print 'Zugriff für P.ABT.BIA_Tool_CISO_TEST'
SET @Gruppe = @domName+'\P.ABT.BIA_Tool_CISO_TEST' 
...
print 'Zugriff für P.ABT.BIA_Tool_Admin_TEST'
SET @Gruppe = @domName+'\P.ABT.BIA_Tool_Admin_TEST' 
...
print 'Zugriff für P.ABT.BIA_Tool_SBA_User_TEST'
SET @Gruppe = @domName+'\P.ABT.BIA_Tool_SBA_User_TEST' 
...
print 'Zugriff für P.ABT.BIA_Tool_Normal_User_TEST'
SET @Gruppe = @domName+'\P.ABT.BIA_Tool_Normal_User_TEST' 
